<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"/usr/blog/public/../application/admin/view/link/edit.html";i:1490321772;s:61:"/usr/blog/public/../application/admin/view/layout_iframe.html";i:1534076040;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<!-- container-fluid -->
<head>
...
<form action="<?php echo url('Admin/Link/edit'); ?>">
    ...
    <table cellpadding="0" cellspacing="0" style="border:0; margin: 0 auto;" class="tc">
        <tr>
            ...
            <td class="tdright">
                <input type="text" name="link_name" placeholder="请输入名称" value="<?php echo $info['link_name']; ?>">
            </td>
        </tr>
        <tr>
            <td width="80" align="right">指向地址：</td>
            <td class="tdright">
                <input type="text" name="link_url" placeholder="请输入指向地址" value="<?php echo $info['link_url']; ?>">
            </td>
        </tr>
        <tr>
            <td width="80" align="right">描述：</td>
            <td class="tdright">
                <textarea name="link_content" class="link_content"><?php echo $info['link_content']; ?></textarea>
            </td>
        </tr>
        <tr>
            <td width="80" align="right">排序：</td>
            <td class="tdright">
                <input type="text" name="link_sort" value="<?php echo $info['link_sort']; ?>">
            </td>
        </tr>
        <tr>
            ...
            <td class="tdright">
                <div class="radio">
                    <input type="radio" name="link_view" id="radio_1" value="1" <?php if($info['link_view'] == '1'): ?>checked<?php endif; ?> /><label for="radio_1">显示</label>&nbsp;
                    <input type="radio" name="link_view" id="radio_2" value="0" <?php if($info['link_view'] == '0'): ?>checked<?php endif; ?> /><label for="radio_2">不显示</label>&nbsp;
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td class="tdright">
                <img src='<?php echo $info['link_favicon']; ?>' style="margin: 10px 0;">
                <input name='link_old_img' value='<?php echo $info['link_favicon']; ?>' type='hidden'>
            </td>
        </tr>
        <tr>
