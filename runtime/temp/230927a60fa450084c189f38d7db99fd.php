<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"/usr/blog/public/../application/admin/view/article/add.html";i:1534128752;s:54:"/usr/blog/public/../application/admin/view/layout.html";i:1534497194;}*/ ?>
<!DOCTYPE html>
<html lang="Zh-cn">
<head>
    <title>Admin</title>
    ...
    <div class="span12">
        ...
        <div class="widget-box">
            <div class="widget-content nopadding">
                <form class="form-horizontal" action="<?php echo url('Admin/Article/add'); ?>"/>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="art_author" value="<?php echo \think\Config::get('auth.adminname'); ?>" />
                    </div>
                </div>
