...
class  Article extends Model
{
     ...
     * 获取首页文章信息
     */
    public function getIndexArticle($count){
        return $this->order('art_id','desc')->limit($count)->select();
    }
    public function getHit($count){
        return $this->order('art_hit','desc')->limit($count)->select();
    }
}